...
public class NamedParameterJdbcTemplateTest {
	...
	public static void main(String[] args) {
		...
		try {
			//invoke b.methods
			listDTO=service.fetchBooksByAuthors("HK","NTZ","DGA");
		...
		try {
			dto=new BookDTO();
			dto.setBookName("DEVoPS"); dto.setAuthor("DIT-Team");
			dto.setCategory("PYTHON"); dto.setPrice(1000);
			dto.setPublisher("Sun Press"); dto.setStatus("yes");
