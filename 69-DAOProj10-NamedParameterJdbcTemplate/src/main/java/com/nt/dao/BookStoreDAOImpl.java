...
public class BookStoreDAOImpl implements BookStoreDAO {
	private static final String  GET_BOOKS_BY_AUTHORS="SELECT BKID,BOOKNAME,AUTHOR,PRICE,PUBLISHER,STATUS,CATEGORY FROM BOOK_STORE WHERE AUTHOR IN(:NTZ,:HK,:DGA) ORDER BY AUTHOR";
	...
	public List<BookBO> findBooksByAuthors(String author1, String author2, String author3) {
		...
		paramsMap.put("HK",author1);
		paramsMap.put("NTZ",author2);
		paramsMap.put("DGA",author3);
