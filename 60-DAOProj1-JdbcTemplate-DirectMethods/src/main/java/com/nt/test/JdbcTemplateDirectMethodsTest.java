...
public class JdbcTemplateDirectMethodsTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("..............................");
		try {
			System.out.println("7499 emp name::"+service.fetchEmpNameByNo(106));
		}
		catch(DataAccessException dae) {
			dae.printStackTrace();
		}
		System.out.println(".........................");
		try {
		 System.out.println("7499 Emp Details are::"+service.fetchEmpDetailsByNo(106));
		}
		catch(DataAccessException dae) {
			dae.printStackTrace();
		}
		...
		System.out.println(".........................");
		try {
		 System.out.println("CFO,COO Desg  Emp Details are::"+service.fetchEmpDetailsByDesgs("CFO","COO"));
		}
		catch(DataAccessException dae) {
		...
		*/
		 try{
			 System.out.println(service.fireEmpsBySalaryRange(40000, 65000));
			 }
		  catch(DataAccessException dae) {
			  dae.printStackTrace(); 
			  }
